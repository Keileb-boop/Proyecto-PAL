        ...
        static void Main(string[] args)
        {
            ...
            switch (option)
            {
                case 1:
                    ...
                    double areaSphere = 4 * Math.PI * Math.Pow(r, 2);
                    Console.WriteLine("El área de la esfera es: " + areaSphere + " cm^2");
                    break;
                case 2:
                    ...
                    double areaPyramid = (b * h) / 2;
                    Console.WriteLine("El área de la pirámide es: " + areaPyramid + " cm^2");
                    break;
                case 3:
                    ...
                    double areaCone = Math.PI * Math.Pow(g, 2) / 2 + Math.PI * g * Math.Sqrt(Math.Pow(g / 2, 2) + Math.Pow(h, 2));
                    Console.WriteLine("El área del cono es: " + areaCone + " cm^2");
                    break;
                default:
